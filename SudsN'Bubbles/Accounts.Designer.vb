...
Partial Class Accounts
    ...
    Private Sub InitializeComponent()
        ...
        btnService.Location = New Point(-227, 140)
        btnService.Name = "btnService"
        btnService.Size = New Size(34, 42)
        btnService.TabIndex = 45
        ...
        btnCustomer.Location = New Point(-234, 63)
        ...
        btnPurchase.Location = New Point(-236, -28)
        btnPurchase.Name = "btnPurchase"
        btnPurchase.Size = New Size(55, 55)
        btnPurchase.TabIndex = 43
        ...
        btnDB.Location = New Point(-228, -96)
        btnDB.Name = "btnDB"
        ...
        Label3.Location = New Point(-166, -170)
        Label3.Name = "Label3"
        ...
        PictureBox7.Location = New Point(-244, -181)
        ...
        PictureBox8.Location = New Point(-181, -179)
        ...
        PictureBox9.Location = New Point(-244, -179)
        ...
        Button1.ForeColor = Color.FromArgb(CByte(252), CByte(252), CByte(252))
        Button1.Location = New Point(17, 319)
        Button1.Name = "Button1"
        Button1.Size = New Size(34, 42)
        Button1.TabIndex = 53
        ...
        btnDashboard.BackgroundImage = CType(resources.GetObject("btnDashboard.BackgroundImage"), Image)
        btnDashboard.FlatStyle = FlatStyle.Flat
        btnDashboard.ForeColor = Color.FromArgb(CByte(252), CByte(252), CByte(252))
        btnDashboard.Location = New Point(16, 83)
        btnDashboard.Name = "btnDashboard"
        btnDashboard.Size = New Size(37, 37)
        ...
        Label1.TabIndex = 49
        Label1.Text = "Accounts Management"
        ' 
        ' PictureBox1
        ' 
        ...
        PictureBox3.Size = New Size(72, 811)
        ...
        btnLogout.Location = New Point(16, 745)
        ...
        PictureBox4.Location = New Point(135, 171)
        PictureBox4.Name = "PictureBox4"
        PictureBox4.Size = New Size(497, 584)
        ...
        ListBox1.Font = New Font("Arial", 10.8F, FontStyle.Regular, GraphicsUnit.Point, CByte(0))
        ListBox1.ForeColor = Color.DimGray
        ListBox1.FormattingEnabled = True
        ListBox1.ItemHeight = 21
        ListBox1.Location = New Point(153, 189)
        ListBox1.Name = "ListBox1"
        ListBox1.Size = New Size(463, 546)
        ...
        ' Button7
        ' 
        Button7.BackColor = Color.FromArgb(CByte(22), CByte(120), CByte(243))
        ...
        grpInfo.Controls.Add(TextBox4)
        grpInfo.Controls.Add(Label6)
        grpInfo.Controls.Add(TextBox5)
